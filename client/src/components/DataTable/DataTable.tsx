  ...
  const renderTableData = () => {
    return data.map((item) => {
      return (
        <tr
          key={item._id}
          className="border-b text-white bg-gray-light hover:bg-white hover:text-gray-dark font-pbold"
        >
          ...
          <td className="px-6 py-6">{item.clicks}</td>
  ...
  return (
    <div className="container mx-auto p-20">
      <div className="relative overflow-x-auto rounded-xl">
        <table className="w-full table-fixed bg-gray-dark text-left rtl:text-right text-gray-500">
          <thead className="text-md uppercase text-gray-50 bg-gray-700 font-pbold ">
            <tr>
